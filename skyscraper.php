    ...
    <?php include 'header.php' ?>
                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">Sky Scraper</h1>
            ...
            <div id="carouselExampleIndicators"   class=" container carclass carousel slide article-slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class ="img-fuild" style="max-width:100%;"src="image/wh01.jpeg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width:100%; " src="image/wh02.jpeg" alt="Second slide">
                    </div>
        ...
        <div class="bckimg" style="padding-bottom:20px;" >
            <div class="container" style="padding-top:45px;">
                <div class="row">
                    <div class="col-md-6">
                    <iframe width="100%" height="330"src="https://www.youtube.com/embed/YXIIrDQ9ov0"></iframe> 
                    </div>
                    <div class="col-md-6">
                        <p style="font-weight:100;font-size:20px;overflow:hidden;word-break:break-all;">Slide down the tallest ride of the park, with great speed and a broad smile</p>
                    </div>
                </div>
            </div>
        </div>
