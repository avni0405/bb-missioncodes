<!DOCTYPE html>
    <?php include 'header.php' ?>
                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">Crazy Bucket</h1>
        ...
        <!-- food carousel -->
        <div class=""  style=" width:100%;padding-bottom:40px;padding-top:40px;background: url(image/bck.jpg);background-attachment: fixed;">
            <div id="carouselExampleIndicators"   class=" container carclass carousel slide article-slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wh01.jpeg">
                    </li>
                    <li class="" data-slide-to="1" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wh02.jpeg">
                    </li>
                    <li class="" data-slide-to="1" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wh03.jpeg">
                    </li>
                    <li class="" data-slide-to="1" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wh04.jpeg">
                    </li>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class ="img-fuild" style="max-width:100%;"src="image/cb01.jpeg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width:100%; " src="image/cb02.jpeg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width:100%; " src="image/cb03.jpeg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width:100%; " src="image/cb04.jpeg" alt="Second slide">
                    </div>
        ...
        <div class="bckimg" style="padding-bottom:20px;" >
            <div class="container" style="padding-top:45px;">
                <div class="row">
                    <div class="col-md-6">
                    <iframe width="100%" height="330"src="https://www.youtube.com/embed/0oVLfMQIwSs"></iframe> 
                    </div>
                    <div class="col-md-6">
                        <p style="font-weight:100;font-size:20px;overflow:hidden;word-break:break-all;">A ride testing your patience, until the “crazy” bucket gets completely filled up and shower upon the water on you making you feel pleasurable.</p>
                    </div>
                </div>
            </div>
        </div>
