    ...
    <?php include 'header.php' ?>
                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">Water Coster</h1>
            ...
            <div id="carouselExampleIndicators"   class=" container carclass carousel slide article-slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wc01.jpg">
                    </li>
                    <li class="" data-slide-to="1" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wc02.jpg">
                    </li>
                    <li class="active" data-slide-to="0" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/wc03.jpg">
                    </li>
                    
                </ol>
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class ="img-fuild" style="max-width:100%;"src="image/wc01.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width:100%; " src="image/wc02.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width:100%; " src="image/wc03.jpg" alt="Second slide">
                    </div>
        ...
        <div class="bckimg" style="padding-bottom:20px;" >
            <div class="container" style="padding-top:45px;">
                <div class="row">
                    <div class="col-md-6">
                    <iframe width="100%" height="330"src="https://www.youtube.com/embed/aXyeigkBp8s"></iframe> 
                    </div>
                    <div class="col-md-6">
                        <p style="font-weight:100;font-size:20px;overflow:hidden;word-break:break-all;">Enjoy the closed tunnel with sparkling interiors while sliding down a spiral path making you feel delightful.</p>
                    </div>
                </div>
            </div>
        </div>
