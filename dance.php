    ...
    <?php include 'header.php' ?>
                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">RAIN DANCE</h1>
            ...
            <div id="carouselExampleIndicators"   class=" container carclass carousel slide article-slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:auto;" src="image/dance01.jpeg">
                    </li>
                    <li class="" data-slide-to="1" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:auto;" src="image/dance02.jpeg">
                    </li>
                    <li class="" data-slide-to="2" data-target="#carouselExampleIndicators">
                        <img alt="" style="max-width: 100%; height:auto;" src="image/dance03.jpeg">
                    </li>
                    <li class="" data-slide-to="2" data-target="#carouselExampleIndicators">
                        <img alt="" style="max-width: 100%; height:auto;" src="image/dance04.jpeg">
                    </li>
                </ol>
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class ="img-fuild" style="max-width: 100%; height:auto;"src="image/dance01.jpeg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width: 100%; height:auto;" src="image/dance02.jpeg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild" style="max-width: 100%; height:auto;"  src="image/dance03.jpeg"alt="Third slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild" style="max-width: 100%; height:auto;"  src="image/dance04.jpeg"alt="Third slide">
                    </div>
                </div>
        ...
        <div class="bckimg" style="padding-bottom:20px;" >
            <div class="container" style="padding-top:45px;">
                <div class="row">
                    <div class="col-md-6">
                    <iframe width="100%" height="330"src="https://www.youtube.com/embed/OJI3KdfyYpI"></iframe> 
                    </div>
                    <div class="col-md-6">
                        <p style="font-weight:100;font-size:20px;overflow:hidden;word-break:break-all;">Enjoy EDMs and showers together at a time and show off your moves making other people go WOW! at the rain dance.</p>
                    </div>
                </div>
            </div>
        </div>
