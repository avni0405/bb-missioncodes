                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">RELEXING AREA</h1>
            ...
            <div id="carouselExampleIndicators"   class=" container carclass carousel slide article-slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:auto;" src="image/relex01.jpg">
                    </li>
                    <li class="" data-slide-to="1" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:auto;" src="image/relex02.jpg">
                    </li>
                </ol>
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class ="img-fuild" style="max-width: 100%; height:auto;"src="image/relex01.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img  class ="img-fuild"  style="max-width: 100%; height:auto;" src="image/relex02.jpg" alt="Second slide">
                    </div>
                </div>
