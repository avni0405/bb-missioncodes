                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">Valvet Thunder</h1>
            ...
            <div id="carouselExampleIndicators"   class=" container carclass carousel slide article-slide" data-ride="carousel">
                ...
                <ol class="carousel-indicators">
                    <li class="active" data-slide-to="0" data-target="#carouselExampleIndicators">
                        <img alt=""  style="max-width: 100%; height:50px;width:100px;" src="image/vt01.jpg">
                    </li>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img  class ="img-fuild" style="max-width:100%;"src="image/vt01.jpg" alt="First slide">
                    </div>
        ...
        <div class="bckimg" style="padding-bottom:20px;" >
            <div class="container" style="padding-top:45px;">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p style="font-weight:100;font-size:20px;overflow:hidden;word-break:break-all;">Coming soon to add up your thrills.</p>
                    </div>
                </div>
            </div>
        </div>
