<!DOCTYPE html>
    <?php include 'header.php' ?>
                    ...
                    <div class="vc_col-sm-12 wpb_column vc_column_container align_center">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                ...
                                <h1 style="font-size: 2.5rem;color: #ffffff;line-height: 1.1;text-align: center;margin-bottom: 50px;;" class="vc_custom_heading">YOUR FUN DESTINATION IS HERE</h1>
        ...
        <div class="map-responsive">
            <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=Blue+Bubble+Water+Park+Sayan+Road+Surat+Gujarat" width="600" height="450" frameborder="0" style="border:0" ></iframe>
        </div> 

        <!-- contact us -->
        <div id="contact"  class="bckimg"> 
            <div class="title" >
                <h2 style="color:white;background-image: linear-gradient(#1da8dc, #98d9f0);position: relative;margin-right: 25%;margin-left:25%;border-style:solid;border-color: white;  border-radius: 15px 50px;"><strong>Contact Us</strong></h2>
            </div><br/><br/>
            <div class="container">
                <div class="row">
